...
mensaje = (horaActual>= horaApertura) ? 'Está abierto': `Está cerrado, hoy abrimos a las ${horaApertura}`; // es importante usar `` y $ para cadenas ya que usar + no es recomendable
